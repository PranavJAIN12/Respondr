        ...
        <div style={styles.container}>
            <div style={styles.card}>
                ...
                <form style={styles.form} onSubmit={handleSubmit}>
                    <input type="text" placeholder="Full Name" style={styles.input} onChange={handleNameChange}/>
                    <input type="email" placeholder="Email" style={styles.input} onChange={handlemailChange} />
                    <input type="password" placeholder="Password" style={styles.input} onChange={handlePassChange} />
